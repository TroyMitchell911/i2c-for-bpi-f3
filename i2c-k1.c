...
static void spacemit_i2c_flush_fifo_buffer(struct spacemit_i2c_dev *i2c)
{
	writel(0, i2c->base + SPACEMIT_IWFIFO_WPTR);
	writel(0, i2c->base + SPACEMIT_IWFIFO_RPTR);
...
{
	u32 data_buf[SPACEMIT_I2C_FIFO_DEPTH];
	u16 len, i;
	bool last_msg = false;
